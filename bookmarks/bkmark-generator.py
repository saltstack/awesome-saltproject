...
bookmarks_content.extend([
    ...
    '\n',
    '<DL><p>\n',
    '    <DT><H3 ADD_DATE="" LAST_MODIFIED="">awesome-saltproject</H3>\n',
    '    <DL><p>\n',
])
...
bookmark_file='bookmarks/awesome-saltproject-bookmarks.html'
...
# Use each header as a subdir of 'awesome-saltproject' bookmark directory
subdirs = {}
index = 0
